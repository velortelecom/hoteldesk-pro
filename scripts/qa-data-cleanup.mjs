...
// Ancrage sur des frontieres de mot. Sans lui, /(qa|e2e|test)/i archivait
// toute entreprise dont le nom CONTIENT ces lettres : un client nomme
// "Testarossa" ou "Qassim" partait avec les donnees de QA.
const QA_PATTERN = /(^|[^a-z])(qa|e2e|test)([^a-z]|$)/i
