...
export const MODULES_REGISTRY = [
  ...
  {
    id: 'support',
    nom: 'Support & Assistance',
    version: '1.0.0',
    icone: '🎫',
    iconeLib: 'life-buoy',
    description: 'Ouvrir un ticket et echanger avec le support de la plateforme',
    route: '/support',
    composant: lazy(() => import('./support/index.jsx')),
    permissionsParRole: {
      employe: { voir: true, creer: true, modifier: false, supprimer: false, exporter: false, valider: false, administrer: false },
      chef_equipe: { voir: true, creer: true, modifier: false, supprimer: false, exporter: false, valider: false, administrer: false },
      responsable: { voir: true, creer: true, modifier: true, supprimer: false, exporter: false, valider: false, administrer: false },
      admin: { voir: true, creer: true, modifier: true, supprimer: true, exporter: true, valider: true, administrer: true },
    },
    dependances: [], plans: ['starter', 'business', 'premium', 'enterprise'],
    templates: ['hotel', 'pharmacie', 'commerce', 'mairie', 'restaurant', 'residence'],
    ordre: 6, categorie: 'general', couleur: '#2563EB', badge: null, actif: true,
    widgets: { tickets_ouverts: true },
  },
  {
    id: 'pointage',
    nom: 'Pointage',
