...
export default function CongesModule({ permissions, entreprise, profile }) {
  return (
    <div style={{ padding: 40, maxWidth: 700, margin: '40px auto', textAlign: 'center' }}>
      ...
      <div style={{ display: 'inline-block', background: '#ECFDF5', color: '#065F46', border: '1px solid #6EE7B7', borderRadius: 20, padding: '4px 14px', fontSize: 12, fontWeight: 700, marginBottom: 16 }}>MODULE ACTIF - v0.1.0</div>
      ...
      <div style={{ background: '#FEF3C7', border: '1px solid #FCD34D', borderRadius: 12, padding: '20px 28px', marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 14, color: '#92400E', fontWeight: 600, margin: 0 }}>Ce module est active dans votre abonnement<br />mais pas encore disponible.</p>
